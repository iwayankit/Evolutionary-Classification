...
feature_dict = {i:label for i,label in zip(
                range(34),
                  ('erythema','scaling','definite_borders','itching','koebner_phenomenon','polygonal_papules','follicular_papules','oral_mucosal_involvement','knee_and_elbow_involvement','scalp_involvement','family_history','melanin_incontinence','eosinophils_in_the_infiltrate', 'd', 'e','f','g', 'h', 'i','j','k', 'l', 'm','n','o', 'p', 'q','r','s', 't','u','v ','w', 'Age', ))}
...
X = df[['erythema','scaling','definite_borders','itching','koebner_phenomenon','polygonal_papules','follicular_papules','oral_mucosal_involvement','knee_and_elbow_involvement','scalp_involvement','family_history','melanin_incontinence','eosinophils_in_the_infiltrate', 'd', 'e','f','g', 'h', 'i','j','k', 'l', 'm','n','o', 'p', 'q','r','s', 't','u','v ','w', 'Age']].values
...
label_dict = {1: 'psoriasis', 2: 'seboreic', 3:'lichen', 4:'pityriasis', 5:'cronic', 6:'pityriasis'}
...
for ax,cnt in zip(axes.ravel(), range(7)):
    ...
    for lab,col in zip(range(1,7), ('blue', 'red', 'green', 'yellow', 'black', 'grey')):
        ax.hist(X[y==lab, cnt],
                   color=col,
    ...
    ax.set_title('Dermatology histogram #%s' %str(cnt+1))
